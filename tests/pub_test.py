...
class TestPub(unittest.TestCase):
    ...
    def test_has_drink_pass(self):
        self.pub.drinks["Beer"] = [Drink("Beer", 5.00, 3), 1]
    ...
    def test_remove_beer_two_beer_one_gin(self):
        self.pub.drinks["Beer"] = [Drink("Beer", 5.00, 3), 2]
        self.pub.drinks["Gin"] = [Drink("Gin", 6.00, 4), 1]
    ...
    def test_has_food_pass(self):
        self.pub.food["Burger"] = [Food("Burger", 6.00, 3), 1]
    ...
    def test_remove_burger_two_burgers_one_chips(self):
        self.pub.food["Burger"] = [Food("Burger", 6.00, 3), 2]
        self.pub.food["Chips"] = [Food("Chips", 2.00, 1), 1]
